...
import (
	...
	"github.com/yannvon/cascadeth/core/bloombits"
	"github.com/yannvon/cascadeth/core/rawdb"
	"github.com/yannvon/cascadeth/core/state/pruner"
	...
	"github.com/yannvon/cascadeth/eth/filters"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	eth.blockchain, err = core.NewBlockChain(chainDb, cacheConfig, chainConfig, eth.engine, vmConfig, eth.shouldPreserve, &config.TxLookupLimit, &eth.etherbase)
	if err != nil {
		return nil, err
	}
