...
var (
	...
	// FIXME YANN
	AllCascadeProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, &CascadeConfig{Period: 0, Epoch: 30000}}
...
// CascadeConfig is the consensus engine configs for consensusless eth.
...
// String implements the stringer interface, returning the consensus engine details.
func (c *CascadeConfig) String() string {
	return "cascade"
}
